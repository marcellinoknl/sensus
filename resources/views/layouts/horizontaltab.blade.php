<div class="navbar-menu-wrapper d-flex align-items-top"> 
    <ul class="navbar-nav">
      <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
        @php
          $currentTime = date('H:i'); // Get the current time in 24-hour format (e.g., "14:30")
          $greeting = '';
      ...
      @endphp
        ...
        <h1 class="welcome-text">{{ $greeting }}, <span class="text-black fw-bold">{{ Auth::user()->full_name }}</span></h1>
