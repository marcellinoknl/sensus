                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="{{ route('schedule.update', $scheduleData->id) }}" class="forms-sample">
                                                ...
                                                <div class="form-group row">
                                                    <label for="census_name" class="col-sm-3 col-form-label">Nama Sensus</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="census_name" name="census_name" value="{{ $scheduleData->census_name }}" placeholder="Nama Sensus">
                                                        @error('census_name')
                                                ...
                                                <div class="form-group row">
                                                  ...
                                                  <div class="col-sm-9">
                                                      <input type="date" class="form-control" id="schedule_end" name="schedule_end" value="{{ convertIndonesianDateToCarbon($scheduleData->schedule_end)->format('Y-m-d') }}" style="width: 190px;">
                                                      @error('schedule_end')
                                                          <div class="text-danger">{{ $message }}</div>
                                                      @enderror
                                                  </div>
